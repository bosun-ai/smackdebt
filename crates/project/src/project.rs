...
use smackdebt_analysis::{
    ...
    ArchitectureFindingKind, ArchitectureGraph, ArchitectureReportFacts, ChangeLeakageFinding,
    Comparison, ComparisonId, CoreSize, Coverage, DependencyEdge, DependencySyntax,
    DependencySyntaxState, Diagnostic, DiagnosticId, DiagnosticKind, DirectoryTree, FileAnalysis,
    FileId, FileRecord, Finding, FindingId, HealthCounts, HealthPolicy, HotspotPolicy, Language,
    ModuleDeclaration, PackageContainment, PackageId, PackageRecord, ParseStatus, Rating, Report,
    ReportBuilder as AnalysisReportBuilder, ReportMode, Scope, ScopeId, ScopeKind, SizePolicy,
    SourceCoverageOutcome, SourceRole, SourceTrust, Thresholds, compare_architecture,
    compare_units, test_declared_files,
};
...
use crate::architecture::{
    ArchitectureBuild, GraphInputs, build_architecture, leakage_evidence_is_complete,
    leakage_findings,
};
#[cfg(test)]
...
#[cfg(test)]
use smackdebt_analysis::{
    DependencyCoverage, FileActivity, GraphEvidence, HistoryAvailability, ResolutionDiagnostic,
    ResolutionIssueKind,
};
#[cfg(test)]
