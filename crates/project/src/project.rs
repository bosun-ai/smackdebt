...
use smackdebt_analysis::{
    ...
    DependencyCoverage, DependencyEdge, DependencySyntax, DependencySyntaxState, Diagnostic,
    DiagnosticId, DiagnosticKind, DirectoryTree, ExternalDependency, FileActivity, FileAnalysis,
    FileDebt, FileId, FileReach, FileRecord, Finding, FindingId, GraphConfigurationFailure,
    GraphEvidence, HealthCounts, HealthPolicy, HistoryAvailability, HotspotPolicy, Language,
    ModuleDeclaration, OrphanFile, PackageClosure, PackageContainment, PackageEdge,
    PackageFileReach, PackageGraphMeasurement, PackageId, PackageRecord, ParseStatus, Rating,
    Report, ReportBuilder as AnalysisReportBuilder, ReportMode, ResolutionDiagnostic, Scope,
    ScopeId, ScopeKind, SizeFinding, SizePolicy, SourceCoverageOutcome, SourceRole, SourceTrust,
    StableDependencyFinding, Thresholds, change_leakage, close_over_packages, compare_architecture,
    compare_units, enters_connection_graph, enters_file_graph, file_reaches, graph_file_count,
    stable_dependency_findings, test_declared_files,
};
...
use crate::manifest_names::{
    ManifestNameIndex, declared_manifest_name, manifest_names_for, manifest_paths_for,
};
