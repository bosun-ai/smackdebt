...
use smackdebt_analysis::{
    ...
    Comparison, ComparisonId, CoreSize, Coverage, DependencyEdge, Diagnostic, DiagnosticId,
    DiagnosticKind, DirectoryTree, FileId, FileRecord, Finding, FindingId, HealthCounts,
    HealthPolicy, HotspotPolicy, Language, PackageContainment, PackageId, PackageRecord,
    ParseStatus, Rating, Report, ReportBuilder as AnalysisReportBuilder, ReportMode, Scope,
    ScopeId, ScopeKind, SizePolicy, SourceCoverageOutcome, SourceRole, SourceTrust, Thresholds,
...
use crate::diff_source::{DiffObjects, DiffResult, DiffSide, DiffUnchanged, analyze_diff_files};
...
use crate::rating::{FileResult, file_result_role, source_coverage, verdict_eligible};
use crate::requests::{
