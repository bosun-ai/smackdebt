...
**C, C++, Go, Java, JavaScript/JSX, Python, Ruby, Rust, TypeScript/TSX, and Vue** (scripts and templates). React uses JSX/TSX support. Unsupported files and parse failures remain visible in coverage warnings.
