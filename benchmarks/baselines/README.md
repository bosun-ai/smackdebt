...
The first release measurements are in `one-file.json` and
`hundred-file.json`. They were recorded from an optimized build after output
correctness checks. The 100-file comparison measured five serial runs at
